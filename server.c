...
void busLists()
{
    ...
    printf("--------------------------------------------------------------------------------------------------------");
    resetColor();
    printf("\n1\tGanga Travels        \tChennai To Banglore         \tRs.750   \t\t07:00  AM");
    printf("\n2\tWelcome Travels      \tVellore To Chennai          \tRs.550    \t\t01:30  PM");
    printf("\n3\tStar Travels         \tSalem To Trichy             \tRs.450    \t\t03:50  PM");
    printf("\n4\tSuper Deluxe Travels \tMadurai To Coimbatore       \tRs.700    \t\t01:00  AM");
    printf("\n5\tSai Baba Travels     \tKanyakumari To Chennai      \tRs.650    \t\t12:05  AM");
    printf("\n6\tShine On Travels     \tChennai to Pondicherry      \tRs.500    \t\t09:30  AM");
    printf("\n7\tMayuri Travels       \tCuddalore To Thanjavur      \tRs.600  \t\t11:00  PM");
    printf("\n8\tRaju Travels         \tDindigul To Thoothukudi     \tRs.550    \t\t08:15  AM");
    printf("\n9\tShree Travels        \tTirunelveli To Kancheepuram \tRs.400   \t\t04:00  PM");
    printf("\n");
        ...
        do {    printf("\n\n====================================================================\n\n");
            ...
            switch (num)
            {
                ...
                case 2:
                    ...
                    {
                        redColor();
                        printf("\nENTER VALID SEAT NUMBER WE HAVE ONLY 40 SEATS IN A BUS !!\n");
                        resetColor();
                        goto busSeatChoice;
                    }
                    ...
                    greenColor();
                    printf("\nYOUR RESERVATION IS SUCCESFULL ");
                    resetColor();
                    printf("\nRESERVATION NUMBER : ");
                    redColor();
                    printf("%d\n", randomNum);
